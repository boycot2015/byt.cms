        ...
        >
          {videoPlayDrawer.video ? (
            <div style={{ position: 'relative', padding: 20,height: 400 }}>
              <iframe width="100%" id="videoFrame" height="100%" data-src={(sourceConfig[videoPlayDrawer.video?.source||'']?.playUrl || '') + videoPlayDrawer.video.url} frameborder="0" allowFullScreen="true" border="0" sandbox="allow-popups allow-scripts allow-same-origin"></iframe>
              <video 
                ...
                style={{
                  ...
                  height:'100%',
                  cursor: 'pointer',
                  background: `url(${videoPlayDrawer.video?.cover || ''}) center/cover no-repeat`,
              }}
