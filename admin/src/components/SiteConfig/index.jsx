      ...
      <Card styles={{ body: { padding: '0 15px 15px' } }}>
        ...
        >
          <Tabs defaultActiveKey="basic">
            ...
            <Tabs.TabPane tab="首页配置" key="home">
              <Row gutter={16}>
                <Col span={12}>
                  <Form.Item
                    name="bannerCount"
                ...
                <Col span={12}>
                  <Form.Item
                    name="categoryCols"
                    label="分类一行展示数量"
                    rules={[{ required: true, message: '请输入一行展示数量' }]}
                  >
                    <InputNumber 
                      min={1} 
                      max={10} 
                      placeholder="一行展示几个分类" 
                      style={{ width: '100%' }} 
                    />
                  </Form.Item>
                </Col>
                <Col span={12}>
                  <Form.Item
                    name="categoryRows"
                    label="分类展示行数"
                    rules={[{ required: true, message: '请输入展示行数' }]}
                  >
                    <InputNumber 
                      min={1} 
                      max={10} 
            ...
            <Tabs.TabPane tab="友情链接" key="links">
              <Form.List
                name="links"
                initialValue={[]}
              >
