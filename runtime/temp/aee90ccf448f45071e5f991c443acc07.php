...
<div class="page-container main-body">
            ...
            <div class="cont-Card-info ">
                ...
                <div class="cont-Card-Header ">
                    ...
                    <span class="cont-Card-icon">
                        <img src="/static_new//images/home/home_card_ic_user@2x.png" />
                    </span>
                    <!-- End Icon -->
                </div>
                <!-- End Header -->
                ...
                <h2 class="cont-Card-H2 ">
                    <?php echo lang('admin/index/welcome/today_visit_count'); ?>
                </h2>

                <div class="cont-Card-textinfo ">
                    <h3 class="cont-Card-H3 ">
                        <?php echo $dashboard_data['today_visit_count']; ?>
                    </h3>
                </div>
            </div>
        </div>
        ...
        <div class="cont-Card-body">
            <div class="cont-Card-info">
                ...
                <div class="cont-Card-Header">
                    <!-- Icon -->
                    <span class="cont-Card-icon">
                        <img src="/static_new//images/home/home_card_ic_purse@2x.png" />
                    </span>
                    <!-- End Icon -->
                ...
                <h2 class="cont-Card-H2">
                    <?php echo lang('admin/index/welcome/today_money_get'); ?></h2>

                <div class="cont-Card-textinfo">
                    <h3 class="cont-Card-H3">
                        <?php echo $dashboard_data['today_money_get']; ?>
                    </h3>
        ...
        <div class="cont-Card-body">
            <div class="cont-Card-info">
                ...
                <div class="cont-Card-Header">
                    <!-- Icon -->
                    <span class="cont-Card-icon">
                        <img src="/static_new//images/home/home_card_ic_time@2x.png" />
                    </span>
                    <!-- End Icon -->
                ...
                <h2 class="cont-Card-H2">
                    <?php echo lang('admin/index/welcome/filed_last_login_time'); ?></h2>

                <div class="cont-Card-textinfo">
                    <h3 class="cont-Card-H3">
                        <?php echo mac_day($admin['admin_last_login_time']); ?></h3>
        ...
        <div class="cont-Card-body">
            <div class="cont-Card-info">
                ...
                <div class="cont-Card-Header">
                    <!-- Icon -->
                    <span class="cont-Card-icon">
                        <img src="/static_new//images/home/home_card_ic_ip@2x.png" />
                    </span>
                    <!-- End Icon -->
                ...
                <h2 class="cont-Card-H2">
                    <?php echo lang('admin/index/welcome/filed_last_login_ip'); ?></h2>

                <div class="cont-Card-textinfo">
                    <h3 class="cont-Card-H3">
                        <?php echo long2ip($admin['admin_last_login_ip']); ?></h3>
                </div>
            </div>
            <!-- End Col -->
        </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
        ...
        <div class="Browsers-card">
            ...
            <div class="Browsers-card-header">
                <h2 class="ms-1 inline-block font-semibold text-[16px] text-gray-800">
                    <?php echo lang('admin/index/welcome/system_status'); ?>
                </h2>
                    ...
                    <div class="grid grid-cols-2 gap-3 max-md:grid-cols-1">
                        ...
                        <div class="p-3  bg-[#3C82F6]  rounded-lg flex items-center">
                            ...
                            <p class="font-semibold text-lg text-white ml-auto mr-4" id="cpu_usage">
                                <?php if(!empty($os_data['cpu_usage'])): ?>
                                <?php echo $os_data['cpu_usage']; ?>%
                                <?php endif; ?>
                            </p>
                        </div>
                        ...
                        <div class="p-3  bg-[#40CC92]  rounded-lg flex items-center">
                            ...
                            <p class="font-semibold text-lg text-white ml-auto mr-4" id="mem_usage">
                                <?php if(!empty($os_data['mem_usage'])): ?>
                                <?php echo $os_data['mem_usage']; ?>%
                                <?php endif; ?>
                            </p>
                        </div>
                ...
                <div class="mt-5">
                    <ul class="space-y-2">
                        <li class="flex justify-between items-center">
                            <span
                                class="text-xs uppercase text-[#4B5563]"><?php echo lang('admin/index/welcome/mem_detail'); ?></span>
                            <span class="text-sm text-gray-800 " id="mem_detail"><?php echo $os_data['mem_used']; ?> MB/
                                <?php echo $os_data['mem_total']; ?> MB</span>
                        </li>
                        <li class="flex justify-between items-center">
                            <span class="text-xs uppercase text-[#4B5563]">
                                <?php echo lang('admin/index/welcome/filed_os'); ?></span>
                        ...
                        <li class="flex justify-between items-center">
                            <span
                                class="text-xs uppercase text-[#4B5563]"><?php echo lang('admin/index/welcome/filed_host'); ?></span>
                            <span class="text-sm text-gray-800 ">
                        ...
                        <li class="flex justify-between items-center">
                            <span
                                class="text-xs uppercase text-[#4B5563]"><?php echo lang('admin/index/welcome/filed_max_upload'); ?></span>
                            <span class="text-sm text-gray-800 ">
                        ...
                        <li class="flex justify-between items-center">
                            <span
                                class="text-xs uppercase text-[#4B5563]"><?php echo lang('admin/index/welcome/filed_date'); ?></span>
                            <span class="text-sm text-gray-800 ">
                                <?php echo date('Y-m-d'); ?>
                            </span>
                        </li>
                        <li class="flex justify-between items-center">
                            <span
                                class="text-xs uppercase text-[#4B5563]"><?php echo lang('admin/index/welcome/filed_php_ver'); ?></span>
                            <span class="text-sm text-gray-800 ">
                        ...
                        <li class="flex justify-between items-center">
                            <span
                                class="text-xs uppercase text-[#4B5563]"><?php echo lang('admin/index/welcome/filed_thinkphp_ver'); ?></span>
                            <span class="text-sm text-gray-800 ">
                        ...
                        <li class="flex justify-between items-center">
                            <span
                                class="text-xs uppercase text-[#4B5563]"><?php echo lang('admin/index/welcome/filed_ver'); ?></span>
                            <span class="text-sm text-gray-800 "><?php echo $version['code']; ?></span>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <div class="Browsers-card">
            ...
            <div class="Browsers-card-header">
                <div>
                    <h2 class="inline-block font-semibold text-gray-800 ">
                        <?php echo lang('admin/index/welcome/disk_space_usage'); ?></h2>
                    <div class="hs-tooltip hover:z-10 inline-block">
                        ...
                        <span
                            ...
                            <?php echo lang('admin/index/welcome/disk_detail_tips'); ?>
                        </span>
                    </div>
                </div>
            </div>
            ...
            <div class="h-full p-5 pt-0">
                <div class="h-full flex flex-col justify-between space-y-4">
                    <div class="space-y-4">
                        <ul id="disk_list">
                            <?php if(is_array($os_data['disk_datas']) || $os_data['disk_datas'] instanceof \think\Collection || $os_data['disk_datas'] instanceof \think\Paginator): $disk_count = 0; $__LIST__ = $os_data['disk_datas'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$disk_data): $mod = ($disk_count % 2 );++$disk_count;?>
                            <li
                                class="flex items-center gap-3 md:gap-10 justify-between gap-x-4 py-4 border-b border-solid border-[#E6E7EB]">
                                <img class="size-[32px]" src="/static_new//images/home/home_ic_disk@2x.png" alt=""
                                    srcset="" />
                                <div class="grow flex flex-col gap-2">
                                    <div class="flex items-center ">
                                        <span class="flex-shrink-0 size-2.5 inline-block
                                            <?php switch($disk_count%7): case "1": ?>bg-blue-600<?php break; case "2": ?>bg-teal-500<?php break; case "3": ?>bg-orange-600<?php break; case "4": ?>bg-yellow-300<?php break; case "5": ?>bg-green-500<?php break; case "6": ?>bg-violet-500<?php break; endswitch; ?>
                                            rounded-sm me-2.5">
                                        </span>
                                        <span class="text-xs text-gray-800 ">
                                            <?php echo $key; if($os_data['os_name']=='WINDOWS'): ?>:/<?php endif; ?>
                                        </span>
                                    </div>
                                    <div class="flex items-center">
                                        <div class="flex w-full h-2 bg-stone-200 rounded-full overflow-hidden  text-xs text-center hs-tooltip hover:z-10"
                                            ...
                                            <div class="flex flex-col justify-center overflow-hidden bg-green-600 text-xs text-white text-center rounded-full whitespace-nowrap"
                                                style="width:<?php echo $disk_data[2]; ?>%" id="chart_<?php echo $disk_count; ?>"></div>
                                            <span id="disk_data_<?php echo $disk_count; ?>"
                                                class="hs-tooltip-content hs-tooltip-shown:opacity-100 hs-tooltip-shown:visible opacity-0 transition-opacity invisible z-10 py-1 px-2 bg-gray-900 text-xs font-medium text-white rounded-lg shadow-sm  hidden"
                                                role="tooltip"
                                                style="position: fixed; inset: auto auto 0px 0px; margin: 0px; transform: translate(1110px, -600px);"
                                                data-popper-placement="top">
                                                <?php echo $disk_data[1]-$disk_data[0]; ?> GB/<?php echo $disk_data[1]; ?> GB
                                            </span>
                                        </div>

                                    </div>
                                </div>
                                <span id="disk_usage_<?php echo $disk_count; ?>" class="text-[24px] font-semibold text-[#1F2937]">
                                    <?php echo $disk_data[2]; ?>%
                                </span>
                            </li>
        ...
        <div class="Browsers-card">
            ...
            <div class="Browsers-card-header">
                <h2 class="inline-block font-semibold text-gray-800 ">
                    <?php echo lang('admin/index/welcome/seven_day_reg_data'); ?>
                </h2>
            </div>
            <!-- End Header -->
            ...
            <div class="h-full pb-5 px-5 space-y-8">
                <h4 class="text-4xl font-medium text-gray-800 Stats-Card-h4">
                    <img class="w-[228px] h-[126px] absolute right-0 top-0"
                        src="/static_new//images/home/home_login_bg@2x.png" alt="" srcset="" />
                    <?php echo $dashboard_data['seven_day_reg_total_count']; if($dashboard_data['raise_reg_user_today']>0): ?>
                    ...
                    <p class="text-sm text-red-500">
                        ...
                        <?php echo $dashboard_data['raise_reg_user_today']; ?>%
                    </p>
                </h4>
                <!-- List Group -->
                <ul class="space-y-3">
                        ...
                        <div>
                            <div class="flex items-center gap-x-2">
                                ...
                                <h2 class="inline-block align-middle text-gray-500 ">
                                    <?php echo lang('admin/index/welcome/reg_users_count'); ?></h2>
                            </div>
                        </div>
                        <div>
                            <span class="text-gray-800 ">
                                <?php echo $dashboard_data['user_count']; ?>
                            </span>
                        </div>
                    </li>
                    <!-- End List Item -->
                    ...
                    <li
                        ...
                        <div>
                            <div class="flex items-center gap-x-2">
                                ...
                                <h2 class="inline-block align-middle text-gray-500 ">
                                    <?php echo lang('admin/index/welcome/active_reg_users_count'); ?></h2>
                            </div>
                        </div>
                        <div>
                            <span class="text-gray-800 ">
                                <?php echo $dashboard_data['user_active_count']; ?>
                            </span>
                        </div>
                    </li>
                    <!-- End List Item -->
        ...
        <div class="Browsers-card-header">
            ...
            <div class="relative inline-block">
                <div class="hs-select relative">
                    <h2 class="inline-block font-semibold text-gray-800 ">
                        <?php echo lang('admin/index/welcome/seven_day_visit_data'); ?>
                    </h2>
                </div>
            </div>
            <!-- End Select -->
        ...
        <div class="flex items-center w-full p-5 h-[300px] max-md:flex-col max-md:h-[500px]">
            <div class="visits ">
                <img class="w-full h-[82px] absolute left-0 bottom-0 max-md:w-fit max-md:left-auto max-md:right-0"
                    src="/static_new//images/home/home_interview_bg@2x.png" alt="" srcset="" />
                <h4 class="text-2xl flex gap-2 font-semibold text-gray-800 ">
                    <div id="visit_sum"><?php echo $dashboard_data['seven_day_visit_total_count']; ?></div>
                    <?php if($dashboard_data['raise_visit_user_today']<=0): ?> <svg
                ...
                <p class="text-sm text-green-500">
                    <?php endif; ?>
                    <?php echo $dashboard_data['raise_visit_user_today']; ?>%
                </p>
            </div>
    ...
    <table class="tbinfo pleft layui-table">
        <thead>
            <th colspan="2"><?php echo lang('admin/index/welcome/tip_update_db'); ?></th>
        </thead>
        <tr>
            <td colspan="2">
                <font class="tif s20"><?php echo lang('admin/index/welcome/tip_update_db_txt'); ?></font><a class="j-iframe"
                    title="<?php echo lang('admin/index/welcome/tip_update_go'); ?>" data-href="<?php echo url('update/step2'); ?>">
                    <font class="tit s20"><?php echo lang('admin/index/welcome/tip_update_go'); ?></font>
                </a>
            </td>
        </tr>
    </table>
...
<link id="apexcharts-css" rel="stylesheet" href="/static_new//css/apexcharts.css">
<script src="/static_new//js/apexcharts.min.js"></script>
<script src="/static_new//js/hs-apexcharts-helpers.js"></script>
<script>
    (function () {
        buildChart(
            ...
            (mode) => ({
                series: [
                    {
                        name: "<?php echo lang('admin/index/welcome/reg_users_count'); ?>",
