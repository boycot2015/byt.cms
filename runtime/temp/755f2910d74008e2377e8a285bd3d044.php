...
<div class="page-container p10">
    ...
    <div class="my-toolbar-box">
        ...
        <div class="layui-btn-group">
            <a data-href="<?php echo url('info'); ?>" class="layui-btn layui-btn-primary j-iframe" data-full="1"><i class="layui-icon">&#xe654;</i><?php echo lang('add'); ?></a>
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <th width="180"><?php echo lang('opt'); ?></th>
            </tr>
            </thead>
