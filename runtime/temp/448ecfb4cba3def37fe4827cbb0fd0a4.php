<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:83:"/Users/boycott/Desktop/my-project/byt.cms/application/admin/view/system/config.html";i:1719736802;s:81:"/Users/boycott/Desktop/my-project/byt.cms/application/admin/view/public/head.html";i:1629786412;s:81:"/Users/boycott/Desktop/my-project/byt.cms/application/admin/view/public/foot.html";i:1629786412;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
        ...
        <div class="layui-tab" lay-filter="tb1">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-form-mid layui-word-aux"><?php echo lang('admin/system/config/site_polyfill_tip'); ?></div>
                </div>
                ...
                <div class="layui-form-item">
                    <label class="layui-form-label"><?php echo lang('admin/system/config/vod_search_optimise_cache_minutes'); ?>：</label>
                    <div class="layui-input-inline">
                        <input type="text" name="app[vod_search_optimise_cache_minutes]" placeholder="" value="<?php echo $config['app']['vod_search_optimise_cache_minutes']; ?>" class="layui-input w150">
                    </div>
                    <div class="layui-form-mid layui-word-aux"><?php echo lang('admin/system/config/vod_search_optimise_cache_minutes_tip'); ?></div>
                </div>
