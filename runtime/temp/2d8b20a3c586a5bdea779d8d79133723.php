<?php if (!defined('THINK_PATH')) exit(); /*a:8:{s:34:"template/mxone/html/label/top.html";i:1653888666;s:81:"/Users/boycott/Desktop/my-project/byt.cms/template/mxone/html/public/include.html";i:1664250000;s:78:"/Users/boycott/Desktop/my-project/byt.cms/template/mxone/html/public/head.html";i:1741942424;s:75:"/Users/boycott/Desktop/my-project/byt.cms/template/mxone/html/ads/adqj.html";i:1625104690;s:78:"/Users/boycott/Desktop/my-project/byt.cms/template/mxone/html/public/foot.html";i:1664185344;s:82:"/Users/boycott/Desktop/my-project/byt.cms/template/mxone/html/public/tcnotice.html";i:1639063956;s:81:"/Users/boycott/Desktop/my-project/byt.cms/template/mxone/html/public/website.html";i:1639063970;s:75:"/Users/boycott/Desktop/my-project/byt.cms/template/mxone/html/ads/addb.html";i:1625104690;}*/ ?>
<!DOCTYPE html>
<html lang="zh-cn">
<head>
      <meta http-equiv="Content-Type" content="text/html; charset=utf-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0">
	<title>影视排行榜 - <?php echo $maccms['site_name']; ?></title>
						...
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								...
								<div class="search-tag">
									<?php $_67d3ff5563970=explode(',',$maccms['search_hot']); if(is_array($_67d3ff5563970) || $_67d3ff5563970 instanceof \think\Collection || $_67d3ff5563970 instanceof \think\Paginator): if( count($_67d3ff5563970)==0 ) : echo "" ;else: foreach($_67d3ff5563970 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_67d3ff55637c8=explode(',',$maccms['search_hot']); if(is_array($_67d3ff55637c8) || $_67d3ff55637c8 instanceof \think\Collection || $_67d3ff55637c8 instanceof \think\Paginator): if( count($_67d3ff55637c8)==0 ) : echo "" ;else: foreach($_67d3ff55637c8 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
...
<?php endif; ?> 
   ...
   <style>
.title-top{   background-image: url(/template/mxone/mxstatic/image/topbg.png);
    height: 200px;
...
.title-top span {        display: block;
 ...
 <main id="main" class="wrapper bgys" >
  ...
  <div class="title-top" ><span>排行榜</span></div>       		
	 <div class="list">
 
		<div class="module-tab">
			<input type="hidden" name="tab" id="tab" class="module-tab-input">
			<label class="module-tab-name">
			    <span class="module-tab-value">全部</span><i class="icon-arrow-bottom"></i></label>
			<div class="module-tab-items">
				<div class="module-tab-title">选择类型<span class="close-drop"><i class="icon-close-o"></i></span></div>
				<div>
				    <span class="module-tab-item tab-item selected" data-dropdown-value="总榜">总榜</span>
					<span class="module-tab-item tab-item" data-dropdown-value="月榜">月榜</span>
					<span class="module-tab-item tab-item" data-dropdown-value="周榜">周榜</span>
					<?php if($mxonest['mxcms']['s7']['hotpxb'] == 1): ?>
					<span class="module-tab-item tab-item" data-dropdown-value="推荐榜">推荐榜</span>
					<?php endif; ?>
...
<div class="tab-list  selected" dataname="总榜">
    <?php $__TAG__ = '{"ids":"'.$mxonest['mxcms']['s7']['diytopids'].'","order":"asc","by":"sort","id":"vo1","key":"key1"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key1 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($key1 % 2 );++$key1;?>
	<div class="list-item">
		<h5 class="item-title">
	    <?php if($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num1']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num1']): ?>
        <i class="<?php echo $mxonest['mxcms']['s7']['icon1']; ?>"></i>
       <?php elseif($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num2']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num2']): ?>
        <i class="<?php echo $mxonest['mxcms']['s7']['icon2']; ?>"></i>
         <?php elseif($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num3']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num3']): ?>
         <i class="<?php echo $mxonest['mxcms']['s7']['icon3']; ?>"></i>
          <?php elseif($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num4']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num4']): ?>
         <i class="<?php echo $mxonest['mxcms']['s7']['icon4']; ?>"></i>
          <?php elseif($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num5']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num5']): ?>
          <i class="<?php echo $mxonest['mxcms']['s7']['icon5']; ?>"></i>
            <?php elseif($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num6']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num6']): ?>
             <i class="<?php echo $mxonest['mxcms']['s7']['icon6']; ?>"></i>
           <?php else: ?>
            <i class="<?php echo $mxonest['mxcms']['s7']['iconmr']; ?>"></i>
           <?php endif; ?>
			<span><?php echo $vo1['type_name']; ?>热播榜</span>
		</h5>
		<?php $__TAG__ = '{"num":"'.$mxonest['mxcms']['s7']['diytopidsnum'].'","type":"'.$vo1['type_id'].'","order":"desc","by":"hits","level":"'.$mxonest['mxcms']['s7']['diytopidslevel'].'","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<a class="item" href="<?php if($mxonest['mxcms']['s2']['tzzt'] == 1): ?><?php echo mac_url_vod_play($vo); else: ?><?php echo mac_url_vod_detail($vo); endif; ?>" title="<?php echo $vo['vod_name']; ?>" target="_blank">
			<span class="<?php if($key == '1'): ?>one<?php endif; if($key == '2'): ?>two<?php endif; if($key == '3'): ?>three<?php endif; ?> order"><?php echo mac_num_fill($key); ?></span>
			<span class="keyword"><?php echo $vo['vod_name']; ?></span>
		</a>
		<?php endforeach; endif; else: echo "" ;endif; ?>
	</div>
	<?php endforeach; endif; else: echo "" ;endif; ?>
...
<div class="tab-list" dataname="月榜">
    <?php $__TAG__ = '{"ids":"'.$mxonest['mxcms']['s7']['diytopids'].'","order":"asc","by":"sort","id":"vo1","key":"key1"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key1 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($key1 % 2 );++$key1;?>
	<div class="list-item">
		<h5 class="item-title">
	    <?php if($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num1']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num1']): ?>
       ...
       <?php elseif($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num2']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num2']): ?>
		...
		<?php $__TAG__ = '{"num":"'.$mxonest['mxcms']['s7']['diytopidsnum'].'","type":"'.$vo1['type_id'].'","order":"desc","by":"hits_month","level":"'.$mxonest['mxcms']['s7']['diytopidslevel'].'","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<a class="item" href="<?php if($mxonest['mxcms']['s2']['tzzt'] == 1): ?><?php echo mac_url_vod_play($vo); else: ?><?php echo mac_url_vod_detail($vo); endif; ?>" title="<?php echo $vo['vod_name']; ?>" target="_blank">
			<span class="<?php if($key == '1'): ?>one<?php endif; if($key == '2'): ?>two<?php endif; if($key == '3'): ?>three<?php endif; ?> order"><?php echo mac_num_fill($key); ?></span>
			<span class="keyword"><?php echo $vo['vod_name']; ?></span>
		</a>
...
<div class="tab-list" dataname="周榜">
    <?php $__TAG__ = '{"ids":"'.$mxonest['mxcms']['s7']['diytopids'].'","order":"asc","by":"sort","id":"vo1","key":"key1"}';$__LIST__ = model("Type")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key1 = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo1): $mod = ($key1 % 2 );++$key1;?>
	<div class="list-item">
		<h5 class="item-title">
	    <?php if($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num1']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num1']): ?>
       ...
       <?php elseif($vo1['type_id_1'] == $mxonest['mxcms']['s7']['num2']||$vo1['type_id'] == $mxonest['mxcms']['s7']['num2']): ?>
		...
		<?php $__TAG__ = '{"num":"'.$mxonest['mxcms']['s7']['diytopidsnum'].'","type":"'.$vo1['type_id'].'","order":"desc","by":"hits_week","level":"'.$mxonest['mxcms']['s7']['diytopidslevel'].'","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<a class="item" href="<?php if($mxonest['mxcms']['s2']['tzzt'] == 1): ?><?php echo mac_url_vod_play($vo); else: ?><?php echo mac_url_vod_detail($vo); endif; ?>" title="<?php echo $vo['vod_name']; ?>" target="_blank">
			<span class="<?php if($key == '1'): ?>one<?php endif; if($key == '2'): ?>two<?php endif; if($key == '3'): ?>three<?php endif; ?> order"><?php echo mac_num_fill($key); ?></span>
			<span class="keyword"><?php echo $vo['vod_name']; ?></span>
		</a>
...
<?php if($mxonest['mxcms']['s7']['hotpxb'] == 1): ?>   
<div class="tab-list" dataname="推荐榜">	     
		  <?php if($mxonest['mxcms']['s7']['hotpxb'] == 1): ?>   
    <div class="list-item">
		<h5 class="item-title">
		...
		<?php $__TAG__ = '{"num":"'.$mxonest['mxcms']['s7']['hotnum'].'","type":"all","order":"desc","by":"hits","level":"'.$mxonest['mxcms']['s7']['hotlevel'].'","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<a class="item" href="<?php if($mxonest['mxcms']['s2']['tzzt'] == 1): ?><?php echo mac_url_vod_play($vo); else: ?><?php echo mac_url_vod_detail($vo); endif; ?>" title="<?php echo $vo['vod_name']; ?>" target="_blank">
			<span class="<?php if($key == '1'): ?>one<?php endif; if($key == '2'): ?>two<?php endif; if($key == '3'): ?>three<?php endif; ?> order"><?php echo mac_num_fill($key); ?></span>
			<span class="keyword"><?php echo $vo['vod_name']; ?></span>
		</a>
	   ...
	   <?php endif; if($mxonest['mxcms']['s7']['zztjb'] == 1): ?>      
	<div class="list-item">
		<h5 class="item-title">
			<i class="icon-play"></i>
			<span>站长推荐榜</span>
		</h5>
		<?php $__TAG__ = '{"num":"'.$mxonest['mxcms']['s7']['zztjnum'].'","type":"all","order":"desc","by":"time","level":"'.$mxonest['mxcms']['s7']['zztjlevel'].'","id":"vo","key":"key"}';$__LIST__ = model("Vod")->listCacheData($__TAG__); if(is_array($__LIST__['list']) || $__LIST__['list'] instanceof \think\Collection || $__LIST__['list'] instanceof \think\Paginator): $key = 0; $__LIST__ = $__LIST__['list'];if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?>
		<a class="item" href="<?php if($mxonest['mxcms']['s2']['tzzt'] == 1): ?><?php echo mac_url_vod_play($vo); else: ?><?php echo mac_url_vod_detail($vo); endif; ?>" title="<?php echo $vo['vod_name']; ?>" target="_blank">
			<span class="<?php if($key == '1'): ?>one<?php endif; if($key == '2'): ?>two<?php endif; if($key == '3'): ?>three<?php endif; ?> order"><?php echo mac_num_fill($key); ?></span>
			<span class="keyword"><?php echo $vo['vod_name']; ?></span>
		</a>
...
<?php endif; if($mxonest['mxcms']['s3']['adqj'] == 1): if($mxonest['mxcms']['s3']['adqj'] == 1): ?>
