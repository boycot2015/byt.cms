<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"/Users/boycott/Desktop/my-project/byt.cms/application/admin/view/domain/index.html";i:1629786404;s:81:"/Users/boycott/Desktop/my-project/byt.cms/application/admin/view/public/head.html";i:1629786412;s:81:"/Users/boycott/Desktop/my-project/byt.cms/application/admin/view/public/foot.html";i:1629786412;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
            ...
            <div class="layui-tab-content">
                ...
                <div class="layui-tab-item layui-show">
                    ...
                    <blockquote class="layui-elem-quote layui-quote-nm">
                        ...
                        <a class="layui-btn layui-btn-primary" href="<?php echo url('export'); ?>" ><?php echo lang('export'); ?></a>
                        <a class="layui-btn layui-btn-primary layui-upload" data-href="<?php echo url('import'); ?>" ><?php echo lang('import'); ?></a>
                    </blockquote>
                    ...
                    <div id="domain_list" class="contents">
                        ...
                        <label class="layui-form-label"><?php echo lang('website'); ?><?php echo $n; ?>：</label>
                            ...
                            <div> <a class="layui-badge-rim j-tr-del" data-href="<?php echo url('del?ids='.$vo['site_url']); ?>" href="javascript:;" title="<?php echo lang('del'); ?>"><?php echo lang('del'); ?></a></div>
                        </div>
                        <?php endforeach; endif; else: echo "" ;endif; ?>
                    </div>
                    <div class="layui-form-item">
                        <label class=""><button class="layui-btn radius j-player-add" type="button"><?php echo lang('add_group'); ?></button></label>
