    ...
    <div class="my-toolbar-box">
        ...
        <div class="mb10">
            ...
            <div class="layui-input-inline w150 m5">
                ...
                <a id="<?php echo mac_filter_xss($param['cjflag']); ?>_<?php echo $vo['type_id']; ?>" data-href="<?php echo url('index/select'); ?>?tab=actor&col=<?php echo mac_filter_xss($param['cjflag']); ?>_<?php echo $vo['type_id']; ?>&ids=1&tpl=select_type&refresh=no&url=collect/bind" data-width="270" data-height="100" class="j-select" >
                    <?php if($vo['isbind'] == 1): ?>
    ...
    <form class="layui-form " method="post" id="pageListForm">
        <table class="layui-table" lay-size="sm">
            ...
            <tr>
                ...
                <th width="60"><?php echo lang('sex'); ?></th>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($vo['actor_name']); ?></td>
...
<script type="text/javascript">
    ...
    {
        if(res.data.st==1){
            $('#'+res.data.id).html("<span class=red>[<?php echo lang('unbind'); ?>]</span>");
        }
        else{
