...
<body>
<link rel="stylesheet" href="/static_new//css/update.css">
<style type="text/css">
    .hs-iframe {
        width: 100%;
        height: 100%;
...
<div class="layui-layout layui-layout-admin w-full">
    <div class="layui-header maccmsTop max-sm:!hidden">
        <div class="fl maccms-header-logo">
            <img class="header-logo-img" src="/static_new//images/logo@2x.png" alt="" />
            <?php echo lang('admin/index/index/name'); ?>
        </div>
    </div>
    <div class="layui-header header-top px-2">
        <div class="top-logo flex gap-2 items-center mr-auto">
            <img class="size-12" src="/static_new//images/logo@2x.png" alt="" />
            <?php echo lang('admin/index/index/name'); ?>
        </div>
        <ul class="layout-right" lay-filter="">
            <li class="nav-item">
                <a href="/" target="_blank"><i class="layui-icon layui-icon-home"></i></a>
            </li>
            <li class="nav-item ">
                <a href="<?php echo url('index/clear'); ?>" class="j-ajax " refresh="yes">
    ...
    <div class="layui-side" id="switchNav">
        <div class="layui-side-scroll navBar" id="navBar">
            <?php if(is_array($menus) || $menus instanceof \think\Collection || $menus instanceof \think\Paginator): $k = 0; $__LIST__ = $menus;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$v): $mod = ($k % 2 );++$k;?>
            <ul class="layui-nav layui-nav-tree">
                <!-- layui-nav-itemed-->
                <li class="layui-nav-item">
                    <a class="nav-row" href="javascript:;">
                        <img class="nav-icon" src="/static_new//images/nav/left_ic_<?php echo $k; ?>_nor@2x.png" alt="" srcset="" />
                        <?php echo $v['name']; ?>
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd>
                            <?php if(($vv['url'] !=='###')): ?>
                            <a class="admin-nav-item" data-id="<?php echo $key; ?><?php echo $kk; ?>" href="<?php echo $vv['url']; ?>">
                                <i class="<?php echo $vv['icon']; ?>"></i> <?php echo $vv['name']; ?>
                            </a>
                            <?php else: ?>
            ...
            <ul class="layui-nav layui-nav-tree md:hidden">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a href="<?php echo url('index/clear'); ?>" class="j-ajax"
                                refresh="yes"><?php echo lang('admin/index/index/menu_cache_clear'); ?></a>
                        </dd>
                        <dd><a href="javascript:void(0);" id="lockScreen"><?php echo lang('admin/index/index/menu_lock'); ?></a>
                        </dd>
        ...
        <div class="layui-tab mag0" id="top_tabs_box" lay-filter="macTab" lay-allowClose="true">
                ...
                <ul class="layui-nav layui-layout-right layui-form flex gap-1 items-center h-[60px]" lay-filter="demo">
                    ...
                    <div class="layui-input-inline  w-[150px]">
                        <select id="languageSelect" name="app[lang]" lay-filter="lang">
                            ...
                            <option value="<?php echo $vo; ?>" <?php if($config['app']['lang'] == $vo): ?> selected <?php endif; ?>><?php echo $vo; ?>
                            </option>
                            <?php endforeach; endif; else: echo "" ;endif; ?>
                        </select>
                    </div>
                    <li class="layui-nav-item flex-shrink-0">
                        ...
                        <dl class="layui-nav-child !top-[28px] !rounded-[10px]">
                            <dd><a href="<?php echo url('index/clear'); ?>" class="j-ajax"
                                    refresh="yes"><?php echo lang('admin/index/index/menu_cache_clear'); ?></a>
                            </dd>
                            <dd><a href="javascript:void(0);" id="lockScreen"><?php echo lang('admin/index/index/menu_lock'); ?></a>
                            </dd>
                    ...
                    <li class="layui-nav-item flex-shrink-0">
                        <a href="/" class="hover:!text-[#40CC92] cursor-pointer !px-[10px]" target="_blank"
                            title="<?php echo lang('admin/index/index/menu_index'); ?>">
                            <svg width="20px" height="20px" viewBox="0 0 20 20" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <defs>
                                    <rect id="path-1" x="0" y="0" width="20" height="20"></rect>
                    ...
                    <li class="layui-nav-item flex-shrink-0 cursor-pointer">
                        <a href="javascript:void;" class="hover:!text-[#40CC92] cursor-pointer !px-[10px]"
                            onclick="chanage_version()" title="<?php echo lang('admin/index/index/old_version'); ?>">
                            <svg width="20px" height="20px" viewBox="0 0 20 20" version="1.1"
                                xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                                <g id="页面-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                    <g id="超级控制台_首页_1122" transform="translate(-1880.000000, -21.000000)">
            ...
            <div class="layui-tab-content max-md:!px-0 max-md:!pt-3">
                <div class="layui-tab-item layui-show">
                    <iframe lay-id="111" src="<?php echo url('index/welcome'); ?>" width="100%" height="100%" frameborder="0"
    ...
    <div class="layui-footer footer center">
        <div class="text-footer"><?php echo lang('maccms_copyright'); ?></div>
    </div>
</div>
...
<script type="text/javascript">
    ...
    layui.use(['element', 'layer', 'form'], function () {
                        ...
                        layer.open({
                            ...
                            content: `
                                <div class="updae_from">
                                    <img class="update_bg" src="/static_new//images/upgrade_pop_rocket_bg@2x.png" alt="" srcset="">
        ...
        form.on('select(lang)', function (data) {
            if (data.value != '') {
                ...
                $.ajax({
                    url: "<?php echo url('system/configlang'); ?>",
                    type: "post",
                    dataType: "json",
    ...
    function chanage_version() {
        $.ajax({
            url: "<?php echo url('system/configVersion'); ?>",
            type: "post",
            dataType: "json",
            data: { 'version': 0 },
            beforeSend: function () {
