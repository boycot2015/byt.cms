						...
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								...
								<div class="search-tag">
									<?php $_67d2eab64c604=explode(',',$maccms['search_hot']); if(is_array($_67d2eab64c604) || $_67d2eab64c604 instanceof \think\Collection || $_67d2eab64c604 instanceof \think\Paginator): if( count($_67d2eab64c604)==0 ) : echo "" ;else: foreach($_67d2eab64c604 as $key2=>$vo2): ?>
					...
					<div class="search-box"><input class="search-input ac_wd txtKeywords" type="text" name="wd" autocomplete="off" placeholder="<?php echo $mxonest['mxcms']['s1']['searchwd']; ?>">
						<div class="search-drop">
							<div class="drop-content-items ac_hot none">
								<div class="list-item list-item-title"><strong>大家都在搜这些影片</strong></div>
								<div class="search-tag">
									<?php $_67d2eab64c4c3=explode(',',$maccms['search_hot']); if(is_array($_67d2eab64c4c3) || $_67d2eab64c4c3 instanceof \think\Collection || $_67d2eab64c4c3 instanceof \think\Paginator): if( count($_67d2eab64c4c3)==0 ) : echo "" ;else: foreach($_67d2eab64c4c3 as $key2=>$vo2): ?>
									<a href="<?php echo mac_url('vod/search',['wd'=>$vo2]); ?>" class="<?php if($key2 < 4): ?>hot <?php else: endif; ?>"><i class="icon-hot"></i><?php echo $vo2; ?></a>
									<?php endforeach; endif; else: echo "" ;endif; ?>
								</div>
							</div>
...
<?php endif; ?> 
		...
		<main id="main" class="wrapper">
			...
			<div class="module-list">
					<?php $_67d2eab64c43b=explode(',','内地,韩国,美国,日本'); if(is_array($_67d2eab64c43b) || $_67d2eab64c43b instanceof \think\Collection || $_67d2eab64c43b instanceof \think\Paginator): if( count($_67d2eab64c43b)==0 ) : echo "" ;else: foreach($_67d2eab64c43b as $key=>$vo): ?>
